    ...
    <div class="container main-content">
        <div class="row">
            ...
            <?php if( get_previous_post_link()) {
                ?>
                    <button type="button" class="prev-posts btn btn-dark text-dark"><?php  previous_post_link( '%link', '%title' );?></button>
                  <?php 
                }else {
                ...
                ?>
                    <button type="button" class="next-posts btn btn-dark text-dark float-right"><?php  next_post_link( '%link', '%title' );?></button>
                  <?php 
                }else {
